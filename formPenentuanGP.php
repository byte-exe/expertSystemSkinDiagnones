            ...
            <?php 
                if(($ID_Gejala == 'G001') AND ($parent == '-')){
                    ...
                    <div class="section-title">
                        ...
                        <h2>Penentuan Jenis Penyakit Kulit</h2>
                    </div>
                                        ...
                                        while ($max = mysqli_fetch_array($data)) {
                                            ...
                                            $data2 = mysqli_query($con, "SELECT * FROM penyakit WHERE ID_Penyakit = '$solusi'");
                                                while ($d2 = mysqli_fetch_array($data2)) {
                                                    ...
                                                    $treatment = $d2['opsiTR'];
                                    ?>   
                                    <p>Anda teridentifikasi memiliki penyakit kulit <b><?php echo $d2['ketPenyakit']; ?><b></p>
                                    <?php
                                                    $data3 = mysqli_query($con, "SELECT * FROM pengobatan WHERE ID_HP = '$ID_HP'");
                                                    while ($d3 = mysqli_fetch_array($data3)) {
                                                        $ketHP = $d3['ketHP'];
                                     ?>
                                     <p>Rekomendasi Obat yang bisa digunakan adalah <b><?php echo $ketHP; ?></b></p>
                                     <?php
                                                    }
                                    ?>
                                    <p>Cara pencegahan yang bisa dilakukan adalah <br> <b><?php echo $treatment; ?></b></p>
                                    <?php
                                            }
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="about__text">
                                    <center>
                                        <br>
                                        <hr>
                                        <p>Pilih tombol "SELESAI" jika ingin menyelesaikan konsultasi penentuan Jenis Penyakit kulit </p>
