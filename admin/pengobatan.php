...
<section class="breadcrumb-option spad set-bg" data-setbg="source/img/bg-header.jpg">
        <div class="container">
            <div class="row">
    ...
    <section class="hero spad set-bg">
        <div class="container">
            <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-md btn-info">
                <a  style="color:white">Tambah Pengobatan </a>&nbsp;&nbsp;<i class="fa fa-plus"></i>
            </button><br><br>
            <a href="printPengobatan.php" class="primary-btn normal-btn">Print Data Pengobatan Penyakit Kulit</a>
					...
					<div class="modal-body">
						<form action="controller/prosesHP.php?aksi=tambah" method="post">
							<div class="form-group">
								<label>Kode Pengobatan</label>
								<input name="ID_HP" type="text" class="form-control" readonly value="<?php print $db->tampil_kode_HP(); ?>">
							</div>
							<div class="form-group">
								<label>Keterangan Pengobatan</label>
								<input name="ketHP" type="text" class="form-control">
                            </div>
							<div class="modal-footer">
							<a href="pengobatan.php"><button type="button" class="btn btn-default">Batal</button></a>
